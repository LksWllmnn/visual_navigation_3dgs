...
# process_directory(gt_dir=gt_dir, pred_dir=pred_dir, output_log=output_log, mapping=mapping)
# pred_dir = Path(r"F:\Studium\Master\Thesis\data\final_final_results\resnet_big-surround\just-mask")
# output_log = Path(r"F:\Studium\Master\Thesis\data\final_final_results\resnet_big-surround\just-mask\output_log.csv")
# process_directory(gt_dir=gt_dir, pred_dir=pred_dir, output_log=output_log, mapping=mapping)
# pred_dir = Path(r"F:\Studium\Master\Thesis\data\final_final_results\resnet_surround\just-mask")
# output_log = Path(r"F:\Studium\Master\Thesis\data\final_final_results\resnet_surround\just-mask\output_log.csv")
# process_directory(gt_dir=gt_dir, pred_dir=pred_dir, output_log=output_log, mapping=mapping)
